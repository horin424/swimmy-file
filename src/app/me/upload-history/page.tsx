...
const previewLabel: Record<ThumbnailPipelineStatus, string> = {
  generated: "Ready",
  pending: "Generating…",
  failed: "Unavailable",
};
    ...
    <div className="mx-auto max-w-6xl px-6 py-8 md:px-10">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Track every upload attempt and its processing status — separate from My Uploads, which manages what&apos;s
          already published.
        </p>
      </div>
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-muted-foreground">
                ...
                <span className="flex items-center gap-1">
                  ...
                  Preview: {previewLabel[entry.thumbnailStatus]}
                </span>
              </div>
